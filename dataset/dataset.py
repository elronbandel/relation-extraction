from datatools.load import read_csv_to_dicts, data_label_split
...
class DataSet:
    def __init__(self, dir):
        self.dir = dir
        self.train_data, self.train_labels = self.load('train.csv')
        self.dev_data, self.dev_labels = self.load('dev.csv')
    ...
    def load(self, file):
        return data_label_split(read_csv_to_dicts(self.dir + '/' + file))
